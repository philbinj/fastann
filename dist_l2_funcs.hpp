...
inline
void
cl2s(const unsigned char* qu, const unsigned char* pnts, 
...
inline
void
cl2f_1_8(const unsigned char* qu, const unsigned char* pnts,
         unsigned N, unsigned D,
         unsigned* dsq_out)
{
    for (unsigned n=0; n < N; ++n) {
        ...
        unsigned d;
        for (d = 0; d < (D&-8); d+=8) {
            dsq_out[n] += ((unsigned)qu[d + 0] - (unsigned)pnt_n[d + 0])*((unsigned)qu[d + 0] - (unsigned)pnt_n[d + 0]);
            dsq_out[n] += ((unsigned)qu[d + 1] - (unsigned)pnt_n[d + 1])*((unsigned)qu[d + 1] - (unsigned)pnt_n[d + 1]);
            dsq_out[n] += ((unsigned)qu[d + 2] - (unsigned)pnt_n[d + 2])*((unsigned)qu[d + 2] - (unsigned)pnt_n[d + 2]);
            dsq_out[n] += ((unsigned)qu[d + 3] - (unsigned)pnt_n[d + 3])*((unsigned)qu[d + 3] - (unsigned)pnt_n[d + 3]);
            dsq_out[n] += ((unsigned)qu[d + 4] - (unsigned)pnt_n[d + 4])*((unsigned)qu[d + 4] - (unsigned)pnt_n[d + 4]);
            dsq_out[n] += ((unsigned)qu[d + 5] - (unsigned)pnt_n[d + 5])*((unsigned)qu[d + 5] - (unsigned)pnt_n[d + 5]);
            dsq_out[n] += ((unsigned)qu[d + 6] - (unsigned)pnt_n[d + 6])*((unsigned)qu[d + 6] - (unsigned)pnt_n[d + 6]);
            dsq_out[n] += ((unsigned)qu[d + 7] - (unsigned)pnt_n[d + 7])*((unsigned)qu[d + 7] - (unsigned)pnt_n[d + 7]);
        }
        for (; d < D; ++d) {
            dsq_out[n] += ((unsigned)qu[d + 0] - (unsigned)pnt_n[d + 0])*((unsigned)qu[d + 0] - (unsigned)pnt_n[d + 0]);
        }
...
inline
void
cl2v_2_32(const unsigned char* qu, const unsigned char* pnts,
          unsigned N, unsigned D,
          unsigned* dsq_out)
{
    static const unsigned char mask_uc[16] __attribute__((aligned(16))) =
...
inline
void
sl2s(const float* qu, const float* pnts,
     unsigned N, unsigned D,
     float* dsq_out)
{
    for (unsigned n=0; n < N; ++n) {
...
inline
void
sl2f_1_8(const float* qu, const float* pnts,
         unsigned N, unsigned D,
         float* dsq_out)
{
    for (unsigned n = 0; n < N; ++n) {
...
inline
void
sl2u_2_8(const float* qu, const float* pnts,
         unsigned N, unsigned D,
         float* dsq_out)
{
    for (unsigned n = 0; n < N; ++n) {
...
inline
void
dl2s(const double* qu, const double* pnts,
     unsigned N, unsigned D,
     double* dsq_out)
{
    for (unsigned n=0; n < N; ++n) {
...
inline
void
dl2f_1_8(const double* qu, const double* pnts,
         unsigned N, unsigned D,
         double* dsq_out)
{
    for (unsigned n=0; n < N; ++n) {
...
inline
void
dl2v_2_8(const double* qu, const double* pnts,
         unsigned N, unsigned D,
         double* dsq_out)
{
    for (unsigned n=0; n < N; ++n) {
