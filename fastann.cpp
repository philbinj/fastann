...
#define C_BUILD_EXACT(SUFFIX, TYPE) \
    extern "C" \
    void* \
    JOIN(fastann_nn_obj_build_exact_,SUFFIX)(TYPE* pnts, unsigned N, unsigned D) \
    { fastann::nn_obj<TYPE>* nno = new fastann::nn_obj_exact<TYPE>(pnts, N, D); return (void*)nno; }
...
#define C_BUILD_KDT(SUFFIX, TYPE) \
    extern "C" \
    void* \
    JOIN(fastann_nn_obj_build_kdtree_,SUFFIX)(TYPE* pnts, unsigned N, unsigned D, unsigned ntrees, unsigned nchecks) \
    { fastann::nn_obj_kdtree<TYPE>* nno = new fastann::nn_obj_kdtree<TYPE>(pnts, N, D, ntrees, nchecks); return (void*)nno; }
...
#define C_NNOBJ_SEARCH_NN(SUFFIX, TYPE1, TYPE2) \
    extern "C" \
    void \
    JOIN(fastann_nn_obj_search_nn_,SUFFIX)(void* p, TYPE1* qus, unsigned N, unsigned* argmins, TYPE2* mins) \
    { fastann::nn_obj<TYPE1>* nno = (fastann::nn_obj<TYPE1>*)p; nno->search_nn(qus, N, argmins, mins); }
...
#define C_NNOBJ_SEARCH_KNN(SUFFIX, TYPE1, TYPE2) \
    extern "C" \
    void \
    JOIN(fastann_nn_obj_search_knn_,SUFFIX)(void* p, TYPE1* qus, unsigned N, unsigned K, unsigned* argmins, TYPE2* mins) \
    { fastann::nn_obj<TYPE1>* nno = (fastann::nn_obj<TYPE1>*)p; nno->search_knn(qus, N, K, argmins, mins); }
...
#define C_NNOBJ_ADD_POINTS(SUFFIX, TYPE) \
    extern "C" \
    void \
    JOIN(fastann_nn_obj_add_points_,SUFFIX)(void* p, TYPE* pnts, unsigned N) \
    { fastann::nn_obj<TYPE>* nno = (fastann::nn_obj<TYPE>*)p; nno->add_points(pnts, N); }
...
#define C_NNOBJ_NDIMS(SUFFIX, TYPE) \
    extern "C" \
    unsigned \
    JOIN(fastann_nn_obj_ndims_,SUFFIX)(void* p) \
    { fastann::nn_obj<TYPE>* nno = (fastann::nn_obj<TYPE>*)p; return nno->ndims(); }
...
#define C_NNOBJ_NPOINTS(SUFFIX, TYPE) \
    extern "C" \
    unsigned \
    JOIN(fastann_nn_obj_npoints_,SUFFIX)(void* p) \
    { fastann::nn_obj<TYPE>* nno = (fastann::nn_obj<TYPE>*)p; return nno->npoints(); }
...
#define C_NNOBJ_DEL(SUFFIX, TYPE) \
    extern "C" \
    void \
    JOIN(fastann_nn_obj_del_,SUFFIX)(void* p) \
    { fastann::nn_obj<TYPE>* nno = (fastann::nn_obj<TYPE>*)p; delete nno; }
