...
struct dist_l2_wrapper
{
};

template<>
struct dist_l2_wrapper<unsigned char>
{ 
    cl2func func;
 ...
 */
template<class Float>
dist_l2_wrapper<Float>
dist_l2_best(unsigned D = 0);
